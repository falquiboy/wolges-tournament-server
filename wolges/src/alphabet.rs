...
// Internal Spanish alphabet for KWG generation with digraphs converted
// CH -> ç, LL -> k, RR -> w
pub fn make_spanish_internal_alphabet() -> Alphabet {
    new_static_alphabet_from_file!("alphabets/spanish_internal.txt")
}
