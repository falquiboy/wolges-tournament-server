...
// Spanish game config with internal alphabet (digraphs converted to single chars)
pub fn make_spanish_internal_game_config() -> GameConfig {
    GameConfig::Static(StaticGameConfig {
        game_rules: GameRules::Classic,
        alphabet: alphabet::make_spanish_internal_alphabet(),
        board_layout: board_layout::make_standard_board_layout(),
        rack_size: 7,
        num_players: 1,
        num_passes_to_end: std::u8::MAX,
        challenges_are_passes: false,
        num_zeros_to_end: 0,
        zeros_can_end_empty_board: false,
        exchanges_are_zeros: true,
